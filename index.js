...
const port = 3000;
let products = [
  { id : 1, name : "iPhone 12", brand : "Xiaomi", price : 60000, ram : 6, rom : 256, rating : 4.5, os: "Android", camera: 108, },
...
//get the products by popularity
...
//filter the products based on RAM option
...
//filter the products based on ROM option
...
//filter the products based on brand option
...
//filter products based on OS option
...
app.get('/products/filter/price',(req,res)=>{
  ...
  let result = filterByPrice(products, price);
  res.json(result);
})
